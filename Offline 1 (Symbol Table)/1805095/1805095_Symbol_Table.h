...
public:
    ...
    void Enter_Scope(int n)
    {
        ...
        cout << "New ScopeTable with id " << new_scope_id << " created" << endl;
    }
    void Exit_Scope()
    {
        ...
        cout << "ScopeTable with id " << this->current_scope_table->get_scope_Id() << " removed" << endl;
    }
    bool Insert_from_symboltable(Symbol_Info *symbol_info)
    {
        ...
        {
            cout << "<" << symbol_info->get_Symbol_name() << "," << symbol_info->get_Symbol_type() << "> already exists in current ScopeTable" << endl;
            delete symbol_info;
            return false;
        }
